...
// import { practiceAreasData } from "../../features/practiceareas/data/practiceAreasData";  
...
//       {/* TITLE */}
//       <h2 className="max-w-[340px] font-bold text-2xl sm:text-3xl lg:text-[40px] leading-[120%] text-[#FEFCE1]">
//         Our others Legal Practice Areas
//       </h2>
//       {/* CARDS */}

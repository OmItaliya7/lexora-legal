...
//   return (
//     <button onClick={onClick} className="flex items-center justify-center gap-1 lg:gap-4 w-full px-10 xl:px-32 py-3 lg:py-5 bg-[#FEFCE1] border border-[#333333] rounded-full">
...
//       <label className="text-xs lg:text-base block pb-2 text-[#D8D6BF]">
//         {label}
//       </label>
//       <div className="relative">
//          <input type={isPasswordField ? showPassword ? "text" : "password" : type} name={name} value={value} onChange={onChange} className="w-full bg-transparent border border-[#403F38] rounded-full px-4 sm:px-5 py-3 lg:py-4 text-white focus:border-white transition"/>
//          {isPasswordField && (
//           <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2  text-[#D8D6BF] text-xl">
//             <img src={showPassword ? showPasswordIcon : hidePasswordIcon} alt={showPassword ? "hide password" : "show password"} />
//           </button>
//          )}
//       </div>
//     </div>
...
// }) => {
//   return (
//     <div className="border border-[#FEFCE1] bg-[#0E100F] px-8 py-6 sm:px-12 sm:py-8 lg:px-16 lg:py-10 text-center relative">

//       {/* Close */}
//       <button aria-label="close" className="absolute top-2 right-2 lg:top-8 lg:right-8 text-[#666666]">
//         <FiX size={32} />
//       </button>
...
//         {/* HEADER */}
//         <div className="mb-10">
//           <img src={userIcon} alt="user" className="mx-auto mb-6" />
//           <h2 className="text-[#FEFCE1] text-xl sm:text-2xl lg:text-[32px] mb-0.5">
//             {title}
//           </h2>
...
//           <button type="button" onClick={onSubmit} className="w-full border border-[#FEFCE1] px-4 sm:px-5 py-3 lg:py-4.5 rounded-full font-semibold text-xl text-[#FEFCE1] hover:bg-white hover:text-black transition">
//             {buttonText}
//           </button>

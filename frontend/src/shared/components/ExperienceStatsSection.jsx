...
//             </h2>
//             <p className="max-w-[1040px] mx-auto font-medium text-sm sm:text-base lg:text-lg text-[#D8D6BF]/60">
...
//           {/* STATS */}
//           <div className="flex flex-wrap justify-center gap-y-12 gap-x-10 sm:gap-x-16 md:gap-x-20 lg:gap-x-32">
            
//             {stats.map((item) => (
//               <div key={item.number} className="text-center">

//                 {/* NUMBER */}
//                 <h3 className="mb-4 lg:mb-6 font-bold text-3xl sm:text-4xl lg:text-[40px] leading-[120%] text-[#FEFCE1]">
//                   {item.number}
//                 </h3>
      ...
      <div className="max-w-[1200px] mx-auto py-17.5 md:py-22.5 lg:py-25">
        <div className="space-y-16 md:space-y-20 lg:space-y-22.5">
          ...
          <div className="text-center space-y-6 lg:space-y-8">
            ...
            <p className="max-w-[1040px] mx-auto font-medium text-sm sm:text-base lg:text-lg text-[#D8D6BF]/60">
              Our experienced attorneys have successfully handled hundreds of legal cases across business law, family law etc. We provide trusted legal guidance and personalized representation for every client.
            </p>
          </div>

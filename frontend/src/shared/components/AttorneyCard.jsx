...
// const AttorneyCard = ({image, name, desc, slug, arrowColor = "text-[#FEFCE1]"}) => {
...
//   return (
//     <div onClick={handleCardClick} className={`group relative overflow-hidden border border-[#FEFCE1] transition-all duration-500 ${active ? "bg-[#FEFCE1] border-transparent" : "bg-transparent lg:hover:bg-[#FEFCE1] lg:hover:border-transparent"}`}>
//       {/* IMAGE */}
//       <img src={image} alt={name} loading="lazy" className="w-full object-center aspect-[380/520]" />
...
//         {/* BUTTON */}
//         <Link to={`/ourteam/${slug}`} className="inline-flex items-center gap-4 py-4 font-semibold text-base text-[#FC8608]">

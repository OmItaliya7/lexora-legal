...
//       <img src={arrowDecor} alt="decor" aria-hidden="true" className="hidden sm:block absolute left-[-28px] top-[10px] lg:top-[25px] 2xl:top-1 w-40 lg:w-50 2xl:w-62.5 pointer-events-none select-none"/>

//       <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 2xl:px-0 py-17.5 md:py-22.5 lg:py-25">
//         <h2 className="mb-12 lg:mb-17.5 font-bold text-3xl sm:text-4xl lg:text-[40px] text-[#FEFCE1] text-center">

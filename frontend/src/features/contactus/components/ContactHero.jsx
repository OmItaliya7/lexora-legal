...
//       <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-12 xl:px-30 2xl:px-0">
//         <Header />
...
//             <h1 className="mb-4.5 text-3xl sm:text-4xl md:text-5xl lg:text-[72px] xl:text-[90px] font-bold leading-[120%] text-[#FEFCE1]">
//               We’re Here to Help
//             </h1>
//             <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-[#D8D6BF]/60">
//               Through 10 years of experience and over 200 million in transaction values we offer the most premium legal services.
//             </p>
//           </div>

//           {/* CONTACT CARDS */}
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-22">
//             {contactData.map(({icon, title, text}, index) => (
//               <div key={index} className="px-5 py-6 sm:px-6 sm:py-8 lg:px-6 lg:py-8.5 border border-[#FEFCE1]">
...
import bgImage from "../../../assets/images/login1-bg.webp";
import Header from "../../../shared/layout/Header";

...
//   return (
//     <section id="our-attorneys-team" className="relative overflow-hidden">

//       {/* GOLDEN ARROW */}
//       <img src={arrowRight} alt="arrow" aria-hidden="true" className="hidden sm:block absolute right-0 top-1 w-[190px] lg:w-auto pointer-events-none"/>
      
//       <div className="max-w-[1440px] mx-auto py-17.5 md:py-22.5 lg:py-25 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 2xl:px-0 border-b border-[#FEFCE1]/20">
//       {/* TITLE */}
//       <h2 className="mb-12 sm:mb-15 lg:mb-17.5 text-center font-bold text-3xl md:text-[40px] leading-[120%] text-[#FEFCE1]">
//         Our Attorneys
//       </h2>

//       {/* GRID */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8 lg:gap-[45px]">
//         {orderedAttorneys.map((item, i) => (
//           <AttorneyCard key={`${item.id}-${i}`} {...item} arrowColor="text-[#FC8608]"/>
//         ))}
//       </div>
    ...
    <section id="our-attorneys-team" aria-labelledby="our-attorneys-heading" className="relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-5">
        <div className="max-w-[1200px] mx-auto py-17.5 md:py-22.5 lg:py-25 border-b border-[#FEFCE1]/20">
          ...
          {/* GRID */}
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-[45px]">
            {orderedAttorneys.map((item, i) => (
              <li key={`${item.id}-${i}`}>

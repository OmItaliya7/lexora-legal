    ...
    <section aria-labelledby="practice-title" className="relative overflow-hidden">
      ...
      <div className="relative z-10 container-main">
        <div className="container-content">
          ...
          {/* MAIN CONTENT */}
          <div className="py-17.5 md:py-20 lg:py-22.5 xl:pt-21.5 xl:pb-30 border-b border-light/25">
            <div className="flex flex-col lg:flex-row lg:items-end gap-10 lg:gap-20 xl:gap-27.5">
              {/* LEFT */}
              <div className="space-y-3 sm:space-y-4">
                <Icon aria-hidden="true" className="size-7 lg:size-8 text-gold" />
                <p className="font-semibold text-sm sm:text-base lg:text-2xl text-gold">
                  Legal Practice Area
                </p>
                <h1 id="practice-title" className="font-bold text-4xl sm:text-[56px] lg:text-[68px] xl:text-[76px] leading-[120%] text-light whitespace-nowrap">
                  {practice.heroTitle}
                </h1>
              </div>
              {/* RIGHT */}
              <p className="max-w-[600px] text-sm sm:text-base lg:text-lg text-light/60">
                {practice.heroDesc}
              </p>
            </div>
          </div>

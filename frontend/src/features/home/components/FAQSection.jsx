...
// import faqImage from "../../../assets/images/home/experienced-attorney-rotate.jpg";
// import arrowDecor from "../../../assets/decorations/arrow-left.png";
...
//       {/* ARROW */}
//       <img src={arrowDecor} loading="lazy" alt="decor" className="hidden sm:block absolute left-[-20px] w-40 xl:w-auto pointer-events-none select-none" />

//       <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 2xl:px-0 py-17.5 md:py-22.5 lg:py-25">

//         <div className="flex flex-col lg:flex-row gap-10 lg:gap-12.5 xl:gap-15 items-center">
//           {/* LEFT IMAGE */}
//           <img src={faqImage} alt="faq" loading="lazy" className="w-full max-w-[350px] lg:max-w-[380px]  aspect-[382/600] object-cover" />

//           {/* RIGHT CONTENT */}
//           <div className="w-full">

//             {/* TITLE */}
//             <h2 className="mb-8 sm:mb-10 lg:mb-15 text-center lg:text-left text-[30px] sm:text-[36px] text-[#FEFCE1]">
...
//                 return (
//                   <div key={index} onClick={() => toggleFAQ(index)} className="flex items-center gap-3 lg:gap-4 cursor-pointer">

//                     {/* ICON */}
//                     <button aria-label={isOpen ? "Close FAQ" : "Open FAQ"} className={`size-9 shrink-0 rounded-full border flex items-center justify-center transition-all duration-300 ${isOpen ? "bg-[#FEFCE1] border-[#E5EFFF] text-[#0E100F]" : "bg-[#403F38] border-[#F0F6FF] text-[#FEFCE1]"}`}>
...
const FAQSection = () => {
  ...
  return (
    <section aria-labelledby="faq-heading" className="relative overflow-hidden">
      {/* ARROW */}
      <img src={arrowDecor} loading="lazy" alt="" aria-hidden="true" className="hidden sm:block absolute left-[-20px] w-40 xl:w-auto pointer-events-none select-none" />

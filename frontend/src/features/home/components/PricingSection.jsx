// import arrowRight from "../../../assets/decorations/arrow-right.png";
// import PricingItem from "./PricingItem";
// import { pricingData } from "../data/pricingData";

// const PricingSection = () => {
//   return (
//     <section className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 2xl:px-0 py-17.5 md:py-22.5 lg:py-25">

//       {/* TOP AREA */}
//       <div className="flex flex-col sm:flex-row items-center gap-6 lg:gap-18 lg:pl-53">
//         {/* ARROW */}
//         <img src={arrowRight} alt="arrow" className="hidden sm:block w-40 md:w-56 lg:w-72 shrink-0 pointer-events-none select-none" />

//         {/* TITLE */}
//         <h2 className="mb-12 lg:mb-15 text-[#FEFCE1] text-[32px] sm:text-[36px] lg:text-[40px] font-bold leading-[120%]">
//           Get the Right <br />
//           Price With Us
//         </h2>
//       </div>
...
//         <button className="px-5 sm:px-6 lg:px-10 py-3 lg:py-4 rounded-full bg-[#FC8608] font-semibold text-sm lg:text-base text-[#0E100F]">
//           Premium member
//         </button>

//         <button className="px-5 sm:px-6 lg:px-10 py-3 lg:py-4 border border-[#FC8608] rounded-full bg-transparent font-semibold text-sm lg:text-base text-[#FC8608]">
//           Non-member
//         </button>

...
const PricingSection = () => {
  return (
    <section aria-labelledby="pricing-heading" className="container-main ">
      <div className="container-content py-17.5 md:py-22.5 lg:py-25">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 lg:gap-18 lg:pl-53">
          ...
          {/* TITLE */}
          <h2 id="pricing-heading" className="mb-12 lg:mb-15 text-light text-[32px] sm:text-[36px] lg:text-[40px] font-bold leading-[120%]">
            Get the Right <br />
            Price With Us
          </h2>
        </div>
        ...
        <div className="space-y-10">
          {pricingData.map((group, index) => (
            <div key={index} className={`${index === pricingData.length - 1 ? "" : "border-b border-light"}`}>
              {group.map((item, i) => (
